<template>
    <q-card flat class="fit">
        ...
        <q-card-section class="q-gutter-md">
            ...
            <q-select v-model="form.paymentStatus" :options="paymentStatusList" label="Status do pagamento" outlined
                dense map-options dropdown-icon="sym_r_expand_more"
                :bg-color="$q.dark.isActive ? 'grey-9' : 'grey-1'" />
