        ...
        <div class="absolute-center full-width">
            <q-item class="text-h5">
                <q-item-section class="text-center">
                    <q-item-label class="text-weight-bold number"> <q-icon name="sym_r_north" color="positive" /> R$
                        <vue3-autocounter :startAmount="0" :endAmount="minMax.max" :duration="1" :autoinit="true"
                            separator="." /></q-item-label>
                    <q-item-label class="text-caption" lines="2">Maior valor</q-item-label>
                </q-item-section>
                <q-item-section class="text-center">
                    <q-item-label class="text-weight-bold number"> <q-icon name="sym_r_south" color="negative" /> R$
                        <vue3-autocounter :startAmount="0" :endAmount="minMax.min" :duration="1" :autoinit="true"
                            separator="." /></q-item-label>
